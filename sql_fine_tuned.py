...
FINE_TUNED_MODEL_NAME = "ft:gpt-3.5-turbo:atradius:sql_converter:id"  # Replace 'id' with the actual ID you receive

def convert_to_databricks_sql(standard_sql):
    """Convert standard SQL to Databricks SQL using the fine-tuned model."""
    conversation = [
